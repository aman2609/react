    ...
    return (
      <div className="about-us mx-[13%]">
        ...
        <p className='text-lg'>
          ...
          bring together the best of local eateries, street food vendors, and
          gourmet restaurants under one roof. With this vision, Tasty Trek was
          launched to create a seamless and enjoyable food delivery experience
          for our customers.{" "}
        </p>
        ...
        <ul className='text-lg'>
          <li>
            ...
            Trek has it all. Our extensive menu features a diverse range of
            cuisines to satisfy every palate.
          </li>
          <li>
            <b>Quality and Freshness</b>: We partner with the best local restaurants
            and food vendors to ensure that every meal delivered through Tasty
            Trek is of the highest quality and freshness. Our stringent quality
            checks and hygiene standards guarantee that you receive only the
            best.
          </li>
          <li>
            <b>Convenience and Speed</b>: With our user-friendly app, ordering your
            favorite meals is just a few taps away. We understand the value of
            your time, and our efficient delivery system ensures that your food
            reaches you hot and fresh, right when you need it.
          </li>
          <li>
            <b>Personalized Experience</b>: At Tasty Trek, we believe in catering to
            your unique preferences. Our app allows you to customize your
            orders, save your favorite dishes, and receive personalized
            recommendations based on your taste.
          </li>
          <li>
            <b>Exclusive Offers and Discounts</b>: We love to delight our customers
            with exciting offers and discounts. Keep an eye out for our special
        ...
        <p className='text-lg'>
          ...
          celebrate their love for food. Our dedicated customer support team is
